...
| - un menu qui permet de naviguer entre les différentes sections                                     | 3      | 0.5    | 1.5   |
...
| Le code source HTML est syntaxiquement correct et lisible <br>
(structure, indentation, pas de CSS inclus directement dans le fichier HTML)                          | 3      | 1.5    | 4.5   |
| Le code source CSS est syntaxiquement correct et lisible <br>
(syntaxe des éléments, indentation, pas de répétition inutile)                                        | 3      | 1      | 3     |
